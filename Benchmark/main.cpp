...
template<typename typeName> struct int_tables {
	...
	static inline constexpr uint8_t digitCounts[]{ 19, 19, 19, 19, 18, 18, 18, 17, 17, 17, 16, 16, 16, 16, 15, 15, 15, 14, 14, 14, 13, 13, 13, 13, 12, 12, 12, 11, 11, 11, 10, 10, 10, 10,
		9, 9, 9, 8, 8, 8, 7, 7, 7, 7, 6, 6, 6, 5, 5, 5, 4, 4, 4, 4, 3, 3, 3, 2, 2, 2, 1, 1, 1, 1, 1 };

	static inline constexpr uint64_t digitCountThresholds[]{ 0ull, 9ull, 99ull, 999ull, 9999ull, 99999ull, 999999ull, 9999999ull, 99999999ull, 999999999ull, 9999999999ull, 99999999999ull,
...
template<size_t count, bnch_swt::string_literal name> JSONIFIER_INLINE void testFunction32() {
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 20, 4>::template runBenchmark<"alternative-digit-count-32", "cyan">([&]() {
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 20, 4>::template runBenchmark<"fast-digit-count-32", "cyan">([&]() {
		uint64_t currentCount{};
		for (size_t x = 0; x < count; ++x) {
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 20, 4>::template runBenchmark<"digit-count-32", "cyan">([&]() {
		uint64_t currentCount{};
		for (size_t x = 0; x < count; ++x) {
			auto newCount = alternative_digit_count(randomIntegers[x]);
			results[x] = newCount;
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 20, 4>::template runBenchmark<"rtc-32-bit", "cyan">([&]() {
		uint64_t currentCount{};
		for (size_t x = 0; x < count; ++x) {
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 20, 4>::printResults(true, true);
}
...
template<size_t count, bnch_swt::string_literal name> JSONIFIER_INLINE void testFunction64() {
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 20, 4>::template runBenchmark<"fast-digit-count-64", "cyan">([&]() {
		uint64_t currentCount{};
		for (size_t x = 0; x < count; ++x) {
			auto newCount = fast_digit_count(randomIntegers[x]);
			results[x] = newCount;
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 20, 4>::template runBenchmark<"alternative-digit-count-64", "cyan">([&]() {
		uint64_t currentCount{};
		for (size_t x = 0; x < count; ++x) {
			auto newCount = alternative_digit_count(randomIntegers[x]);
			results[x] = newCount;
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 20, 4>::template runBenchmark<"digit-count-64", "cyan">([&]() {
		uint64_t currentCount{};
		for (size_t x = 0; x < count; ++x) {
			auto newCount = alternative_digit_count(randomIntegers[x]);
			results[x] = newCount;
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 20, 4>::template runBenchmark<"rtc-64-bit", "cyan">([&]() {
		uint64_t currentCount{};
		for (size_t x = 0; x < count; ++x) {
			auto newCount = fastDigitCount(randomIntegers[x]);
			results[x] = newCount;
