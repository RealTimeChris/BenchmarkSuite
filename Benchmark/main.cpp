...
class implementation_base {
  public:
	virtual void ggml_vec_dot_q8_0_f32(int n, float* s, size_t bs, const void* vx, size_t bx, const void* vy, size_t by, int nrc) const = 0;
};
...
class arm_implementation : public implementation_base {
  public:
	void ggml_vec_dot_q8_0_f32(int n, float* s, size_t bs, const void* vx, size_t bx, const void* vy, size_t by, int nrc) const override {
...
void arm_work(int n, float* s, size_t bs, const void* vx, size_t bx, const void* vy, size_t by, int nrc) {
	static constexpr int qk = 16;
	const int nb			= n / qk;
	( void )(nrc);
	( void )(bx);
...
void avx_work(int n, float* s, size_t bs, const void* vx, size_t bx, const void* vy, size_t by, int nrc) {
	static constexpr int qk = 32;
	const int nb			= n / qk;
...
void avx2_work(int n, float* s, size_t bs, const void* vx, size_t bx, const void* vy, size_t by, int nrc) {
	static constexpr int qk = 32;
	const int nb			= n / qk;
	( void )(nrc);
	( void )(bx);
...
void avx512_work(int n, float* s, size_t bs, const void* vx, size_t bx, const void* vy, size_t by, int nrc) {
	static constexpr int qk = 32;
	const int nb			= n / qk;
	( void )(nrc);
	( void )(bx);
...
static constexpr uint64_t nCount4{ 12992 };
static constexpr uint64_t nCount{ nCount4 / 4 };
...
int main() {
	alignas(32) char testValues[32]{};
	_mm256_load_si256(( const __m256i* )(testValues));
