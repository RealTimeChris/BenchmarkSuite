...
template<size_t count, bnch_swt::string_literal name> JSONIFIER_INLINE void testFunction32() {
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 100, 20>::template runBenchmark<"alternative-digit-count-32", "cyan">([&]() {
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 100, 20>::template runBenchmark<"fast-digit-count-32", "cyan">([&]() {
		uint64_t currentCount{};
		for (size_t x = 0; x < count; ++x) {
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 100, 20>::template runBenchmark<"digit-count-32", "cyan">([&]() {
		uint64_t currentCount{};
		for (size_t x = 0; x < count; ++x) {
			auto newCount = alternative_digit_count(randomIntegers[x]);
			results[x] = newCount;
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 100, 20>::template runBenchmark<"rtc-32-bit", "cyan">([&]() {
		uint64_t currentCount{};
		for (size_t x = 0; x < count; ++x) {
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 100, 20>::printResults(true, true);
}
...
template<size_t count, bnch_swt::string_literal name> JSONIFIER_INLINE void testFunction64() {
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 100, 20>::template runBenchmark<"fast-digit-count-64", "cyan">([&]() {
		uint64_t currentCount{};
		for (size_t x = 0; x < count; ++x) {
			auto newCount = fast_digit_count(randomIntegers[x]);
			results[x] = newCount;
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 100, 20>::template runBenchmark<"alternative-digit-count-64", "cyan">([&]() {
		uint64_t currentCount{};
		for (size_t x = 0; x < count; ++x) {
			auto newCount = alternative_digit_count(randomIntegers[x]);
			results[x] = newCount;
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 100, 20>::template runBenchmark<"digit-count-64", "cyan">([&]() {
		uint64_t currentCount{};
		for (size_t x = 0; x < count; ++x) {
			auto newCount = alternative_digit_count(randomIntegers[x]);
			results[x] = newCount;
	...
	bnch_swt::benchmark_stage<"compare-decimal-counting-functions-" + name, 100, 20>::template runBenchmark<"rtc-64-bit", "cyan">([&]() {
		uint64_t currentCount{};
		for (size_t x = 0; x < count; ++x) {
			auto newCount = fastDigitCount(randomIntegers[x]);
			results[x] = newCount;
