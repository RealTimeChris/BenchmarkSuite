...
static constexpr auto maxIterations{ 1600 };
...
int main() {
	testFunction<1, 0, uint64_t, "int-to-string-comparisons-1">();
	testFunction<2, 0, uint64_t, "int-to-string-comparisons-2">();
	testFunction<4, 0, uint64_t, "int-to-string-comparisons-4">();
	testFunction<8, 0, uint64_t, "int-to-string-comparisons-8">();
	testFunction<16, 0, uint64_t, "int-to-string-comparisons-16">();
	testFunction<32, 0, uint64_t, "int-to-string-comparisons-32">();
	return 0;
}