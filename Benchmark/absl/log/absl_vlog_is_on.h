...
#include "../log/internal/vlog_config.h"// IWYU pragma: export
#include "../strings/string_view.h"

// IWYU pragma: private, include "../log/log.h"
...
#define ABSL_VLOG_IS_ON(verbose_level) \
	(ABSL_LOG_INTERNAL_MAX_LOG_VERBOSITY_CHECK(verbose_level)[]()->::absl::log_internal::VLogSite * \
		{ \
