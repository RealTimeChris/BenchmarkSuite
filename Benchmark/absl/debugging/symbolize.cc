...
#include "../debugging/symbolize_elf.inc"
#elif defined(ABSL_INTERNAL_HAVE_SYMBOLIZE_WIN32)
// The Windows Symbolizer only works if PDB files containing the debug info
// are available to the program at runtime.
#include "../debugging/symbolize_win32.inc"
#elif defined(__APPLE__)
#include "../debugging/symbolize_darwin.inc"
#elif defined(ABSL_INTERNAL_HAVE_SYMBOLIZE_WASM)
#include "../debugging/symbolize_emscripten.inc"
#else
#include "../debugging/symbolize_unimplemented.inc"
#endif
