...
namespace absl {
	...
	namespace ascii_internal {
		...
		void AsciiStrToLower(absl::Nonnull<char*> dst, absl::Nullable<const char*> src, size_t n);

		void AsciiStrToUpper(absl::Nonnull<char*> dst, absl::Nullable<const char*> src, size_t n);
	...
	template<int&... DoNotSpecify> ABSL_MUST_USE_RESULT inline std::string AsciiStrToLower(std::string&& s) {
	...
	//
	// (Template is used to lower priority of this overload.)
	template<int&... DoNotSpecify> ABSL_MUST_USE_RESULT inline std::string AsciiStrToUpper(std::string&& s) {
		std::string result = std::move(s);
	...
	// given string_view.
	ABSL_MUST_USE_RESULT inline absl::string_view StripLeadingAsciiWhitespace(absl::string_view str) {
	...
	// string_view.
	ABSL_MUST_USE_RESULT inline absl::string_view StripTrailingAsciiWhitespace(absl::string_view str) {
	...
	// given string_view.
	ABSL_MUST_USE_RESULT inline absl::string_view StripAsciiWhitespace(absl::string_view str) {
