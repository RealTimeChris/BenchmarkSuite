...
namespace absl {
	...
	class CordBuffer {
	  ...
	  private:
		...
		template<typename... AllocationHints> static CordBuffer CreateWithCustomLimitImpl(size_t block_size, size_t capacity, AllocationHints... hints);
	...
	template<typename... AllocationHints> inline CordBuffer CordBuffer::CreateWithCustomLimitImpl(size_t block_size, size_t capacity, AllocationHints... hints) {
