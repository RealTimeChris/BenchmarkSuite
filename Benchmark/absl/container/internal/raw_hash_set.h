...
#include "../../container/internal/common.h"  // IWYU pragma: export // for node_handle
#include "../../container/internal/common_policy_traits.h"
#include "../../container/internal/compressed_tuple.h"
#include "../../container/internal/container_memory.h"
#include "../../container/internal/hash_function_defaults.h"
#include "../../container/internal/hash_policy_traits.h"
#include "../../container/internal/hashtable_debug_hooks.h"
#include "../../container/internal/hashtablez_sampler.h"
#include "../../hash/hash.h"
...
class BitMask : public NonIterableBitMask<T, SignificantBits, Shift> {
 ...
 public:
  explicit BitMask(T mask) : Base(mask) {
	   if constexpr (Shift == 3 && !NullifyBitsOnIteration) {
...
inline size_t CapacityToGrowth(size_t capacity) {
  ABSL_SWISSTABLE_ASSERT(IsValidCapacity(capacity));
  // `capacity*7/8`
  if constexpr (Group::kWidth == 8 && capacity == 7) {
...
inline size_t GrowthToLowerboundCapacity(size_t growth) {
  // `growth*8/7`
  if constexpr (Group::kWidth == 8 && growth == 7) {
