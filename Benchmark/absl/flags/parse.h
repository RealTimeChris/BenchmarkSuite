...
namespace absl {
	...
	struct UnrecognizedFlag {
		...
		explicit UnrecognizedFlag(Source s, absl::string_view f) : source(s), flag_name(f) {
		}
	...
	namespace flags_internal {
		...
		HelpMode ParseAbseilFlagsOnlyImpl(int argc, char* argv[], std::vector<char*>& positional_args, std::vector<UnrecognizedFlag>& unrecognized_flags,
