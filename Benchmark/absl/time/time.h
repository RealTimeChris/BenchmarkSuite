...
#include "../time/civil_time.h"
#include "../time/internal/cctz/include/cctz/time_zone.h"
...
namespace absl {
	...
	namespace time_internal {
		...
		ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration MakeDuration(int64_t hi, uint32_t lo);
		ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration MakeDuration(int64_t hi, int64_t lo);
		ABSL_ATTRIBUTE_CONST_FUNCTION inline Duration MakePosDoubleDuration(double n);
		constexpr int64_t kTicksPerNanosecond = 4;
		constexpr int64_t kTicksPerSecond	  = 1000 * 1000 * 1000 * kTicksPerNanosecond;
		template<std::intmax_t N> ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration FromInt64(int64_t v, std::ratio<1, N>);
		ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration FromInt64(int64_t v, std::ratio<60>);
		ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration FromInt64(int64_t v, std::ratio<3600>);
		...
		class HiRep {
		  public:
			...
			constexpr int64_t Get() const {
				...
				// destination type."
				static_assert((static_cast<int64_t>((std::numeric_limits<uint64_t>::max)()) == int64_t{ -1 }) &&
						(static_cast<int64_t>(static_cast<uint64_t>((std::numeric_limits<int64_t>::max)()) + 1) == (std::numeric_limits<int64_t>::min)()),
	...
	ABSL_ATTRIBUTE_CONST_FUNCTION constexpr std::strong_ordering operator<=>(Duration lhs, Duration rhs);
	...
	ABSL_ATTRIBUTE_CONST_FUNCTION inline Duration operator+(Duration lhs, Duration rhs) {
		return lhs += rhs;
	}
	ABSL_ATTRIBUTE_CONST_FUNCTION inline Duration operator-(Duration lhs, Duration rhs) {
		return lhs -= rhs;
	...
	template<typename T> ABSL_ATTRIBUTE_CONST_FUNCTION Duration operator*(Duration lhs, T rhs) {
		return lhs *= rhs;
	}
	template<typename T> ABSL_ATTRIBUTE_CONST_FUNCTION Duration operator*(T lhs, Duration rhs) {
		return rhs *= lhs;
	}
	template<typename T> ABSL_ATTRIBUTE_CONST_FUNCTION Duration operator/(Duration lhs, T rhs) {
		return lhs /= rhs;
	}
	ABSL_ATTRIBUTE_CONST_FUNCTION inline int64_t operator/(Duration lhs, Duration rhs) {
	...
	template<typename T, time_internal::EnableIfIntegral<T> = 0> ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration Nanoseconds(T n) {
		return time_internal::FromInt64(n, std::nano{});
	}
	template<typename T, time_internal::EnableIfIntegral<T> = 0> ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration Microseconds(T n) {
		return time_internal::FromInt64(n, std::micro{});
	}
	template<typename T, time_internal::EnableIfIntegral<T> = 0> ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration Milliseconds(T n) {
		return time_internal::FromInt64(n, std::milli{});
	}
	template<typename T, time_internal::EnableIfIntegral<T> = 0> ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration Seconds(T n) {
		return time_internal::FromInt64(n, std::ratio<1>{});
	}
	template<typename T, time_internal::EnableIfIntegral<T> = 0> ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration Minutes(T n) {
		return time_internal::FromInt64(n, std::ratio<60>{});
	}
	template<typename T, time_internal::EnableIfIntegral<T> = 0> ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration Hours(T n) {
	...
	template<typename T, time_internal::EnableIfFloat<T> = 0> ABSL_ATTRIBUTE_CONST_FUNCTION Duration Nanoseconds(T n) {
		return n * Nanoseconds(1);
	}
	template<typename T, time_internal::EnableIfFloat<T> = 0> ABSL_ATTRIBUTE_CONST_FUNCTION Duration Microseconds(T n) {
		return n * Microseconds(1);
	}
	template<typename T, time_internal::EnableIfFloat<T> = 0> ABSL_ATTRIBUTE_CONST_FUNCTION Duration Milliseconds(T n) {
		return n * Milliseconds(1);
	}
	template<typename T, time_internal::EnableIfFloat<T> = 0> ABSL_ATTRIBUTE_CONST_FUNCTION Duration Seconds(T n) {
	...
	template<typename T, time_internal::EnableIfFloat<T> = 0> ABSL_ATTRIBUTE_CONST_FUNCTION Duration Minutes(T n) {
		return n * Minutes(1);
	}
	template<typename T, time_internal::EnableIfFloat<T> = 0> ABSL_ATTRIBUTE_CONST_FUNCTION Duration Hours(T n) {
		return n * Hours(1);
	}
	...
	ABSL_ATTRIBUTE_PURE_FUNCTION constexpr Duration FromChrono(const std::chrono::nanoseconds& d);
	ABSL_ATTRIBUTE_PURE_FUNCTION constexpr Duration FromChrono(const std::chrono::microseconds& d);
	ABSL_ATTRIBUTE_PURE_FUNCTION constexpr Duration FromChrono(const std::chrono::milliseconds& d);
	ABSL_ATTRIBUTE_PURE_FUNCTION constexpr Duration FromChrono(const std::chrono::seconds& d);
	ABSL_ATTRIBUTE_PURE_FUNCTION constexpr Duration FromChrono(const std::chrono::minutes& d);
	ABSL_ATTRIBUTE_PURE_FUNCTION constexpr Duration FromChrono(const std::chrono::hours& d);
	...
	ABSL_ATTRIBUTE_CONST_FUNCTION std::chrono::nanoseconds ToChronoNanoseconds(Duration d);
	ABSL_ATTRIBUTE_CONST_FUNCTION std::chrono::microseconds ToChronoMicroseconds(Duration d);
	ABSL_ATTRIBUTE_CONST_FUNCTION std::chrono::milliseconds ToChronoMilliseconds(Duration d);
	...
	template<typename Sink> void AbslStringify(Sink& sink, Duration d) {
	...
	class Time {
	  public:
		...
		template<typename H> friend H AbslHashValue(H h, Time t) {
...
// Relational Operators
	...
	ABSL_ATTRIBUTE_CONST_FUNCTION constexpr std::strong_ordering operator<=>(Time lhs, Time rhs) {
	...
	ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Time UnixEpoch() {
		return Time();
	}
	...
	ABSL_ATTRIBUTE_PURE_FUNCTION Time FromChrono(const std::chrono::system_clock::time_point& tp);
	...
	ABSL_ATTRIBUTE_CONST_FUNCTION std::chrono::system_clock::time_point ToChronoTime(Time);
	...
	class TimeZone {
	  public:
		...
		template<typename H> friend H AbslHashValue(H h, TimeZone tz) {
	...
	inline TimeZone FixedTimeZone(int seconds) {
		return TimeZone(time_internal::cctz::fixed_time_zone(std::chrono::seconds(seconds)));
	}
	...
	ABSL_ATTRIBUTE_PURE_FUNCTION inline CivilSecond ToCivilSecond(Time t, TimeZone tz) {
		return tz.At(t).cs;// already a CivilSecond
	}
	ABSL_ATTRIBUTE_PURE_FUNCTION inline CivilMinute ToCivilMinute(Time t, TimeZone tz) {
	...
	ABSL_ATTRIBUTE_PURE_FUNCTION inline CivilMonth ToCivilMonth(Time t, TimeZone tz) {
	...
	ABSL_ATTRIBUTE_PURE_FUNCTION inline Time FromCivil(CivilSecond ct, TimeZone tz) {
	...
	//
	ABSL_ATTRIBUTE_PURE_FUNCTION std::string FormatTime(absl::string_view format, Time t, TimeZone tz);
	...
	// Support for StrFormat(), StrCat() etc.
	template<typename Sink> void AbslStringify(Sink& sink, Time t) {
	...
	namespace time_internal {
		...
		// in time/duration.cc.
		ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration MakeDuration(int64_t hi, uint32_t lo = 0) {
		...
		ABSL_ATTRIBUTE_CONST_FUNCTION inline Duration MakePosDoubleDuration(double n) {
			...
			const uint32_t ticks   = static_cast<uint32_t>(std::round((n - static_cast<double>(int_secs)) * kTicksPerSecond));
		...
		ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration MakeNormalizedDuration(int64_t sec, int64_t ticks) {
		...
		ABSL_ATTRIBUTE_CONST_FUNCTION constexpr int64_t NegateAndSubtractOne(int64_t n) {
		...
		ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration FromInt64(int64_t v, std::ratio<60>) {
			return (v <= (std::numeric_limits<int64_t>::max)() / 60 && v >= (std::numeric_limits<int64_t>::min)() / 60) ? MakeDuration(v * 60)
				: v > 0																									? InfiniteDuration()
																														: -InfiniteDuration();
		}
		ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration FromInt64(int64_t v, std::ratio<3600>) {
			return (v <= (std::numeric_limits<int64_t>::max)() / 3600 && v >= (std::numeric_limits<int64_t>::min)() / 3600) ? MakeDuration(v * 3600)
				: v > 0																										? InfiniteDuration()
																															: -InfiniteDuration();
		}
		...
		template<typename T> constexpr auto IsValidRep64(int) -> decltype(int64_t{ std::declval<T>() } == 0) {
			return true;
		}
		template<typename T> constexpr auto IsValidRep64(char) -> bool {
			return false;
		}

		// Converts a std::chrono::duration to an absl::Duration.
		template<typename Rep, typename Period> ABSL_ATTRIBUTE_PURE_FUNCTION constexpr Duration FromChrono(const std::chrono::duration<Rep, Period>& d) {
			static_assert(IsValidRep64<Rep>(0), "duration::rep is invalid");
			return FromInt64(int64_t{ d.count() }, Period{});
		}

		template<typename Ratio> ABSL_ATTRIBUTE_CONST_FUNCTION int64_t ToInt64(Duration d, Ratio) {
		...
		ABSL_ATTRIBUTE_CONST_FUNCTION inline int64_t ToInt64(Duration d, std::ratio<1>) {
			return ToInt64Seconds(d);
		}
		ABSL_ATTRIBUTE_CONST_FUNCTION inline int64_t ToInt64(Duration d, std::ratio<60>) {
			return ToInt64Minutes(d);
		}
		ABSL_ATTRIBUTE_CONST_FUNCTION inline int64_t ToInt64(Duration d, std::ratio<3600>) {
			return ToInt64Hours(d);
		}

		// Converts an absl::Duration to a chrono duration of type T.
		template<typename T> ABSL_ATTRIBUTE_CONST_FUNCTION T ToChronoDuration(Duration d) {
	...
	ABSL_ATTRIBUTE_CONST_FUNCTION constexpr bool operator<(Duration lhs, Duration rhs) {
		return time_internal::GetRepHi(lhs) != time_internal::GetRepHi(rhs)			? time_internal::GetRepHi(lhs) < time_internal::GetRepHi(rhs)
			: time_internal::GetRepHi(lhs) == (std::numeric_limits<int64_t>::min)() ? time_internal::GetRepLo(lhs) + 1 < time_internal::GetRepLo(rhs) + 1
	...
	ABSL_ATTRIBUTE_CONST_FUNCTION constexpr std::strong_ordering operator<=>(Duration lhs, Duration rhs) {
		...
		return (lhs_hi == (std::numeric_limits<int64_t>::min)()) ? (lhs_lo + 1) <=> (rhs_lo + 1) : lhs_lo <=> rhs_lo;
	}
	...
	ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration operator-(Duration d) {
		...
		return time_internal::GetRepLo(d) == 0
			? time_internal::GetRepHi(d) == (std::numeric_limits<int64_t>::min)() ? InfiniteDuration() : time_internal::MakeDuration(-time_internal::GetRepHi(d))
			: time_internal::IsInfiniteDuration(d)
			? time_internal::OppositeInfinity(d)
			: time_internal::MakeDuration(time_internal::NegateAndSubtractOne(time_internal::GetRepHi(d)), time_internal::kTicksPerSecond - time_internal::GetRepLo(d));
	}
