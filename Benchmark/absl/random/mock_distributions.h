...
#include "../random/internal/mock_overload_set.h"
#include "../random/internal/mock_validators.h"
#include "../random/log_uniform_int_distribution.h"
#include "../random/mocking_bit_gen.h"
...
namespace absl {
	...
	//  assert(x == 123456)
	//
	template<typename R> using MockUniform = random_internal::MockOverloadSetWithValidator<random_internal::UniformDistributionWrapper<R>,
	...
	//  assert(x == 12.3456789)
	//
	template<typename RealType> using MockExponential = random_internal::MockOverloadSet<absl::exponential_distribution<RealType>, RealType(MockingBitGen&, RealType)>;
	...
	//  assert(x == 12.3456789)
	//
	template<typename RealType> using MockGaussian = random_internal::MockOverloadSet<absl::gaussian_distribution<RealType>, RealType(MockingBitGen&, RealType, RealType)>;
	...
	//  assert(x == 1221)
	//
	template<typename IntType> using MockLogUniform =
		random_internal::MockOverloadSet<absl::log_uniform_int_distribution<IntType>, IntType(MockingBitGen&, IntType, IntType, IntType)>;
	...
	//  assert(x == 1221)
	//
	template<typename IntType> using MockZipf = random_internal::MockOverloadSet<absl::zipf_distribution<IntType>, IntType(MockingBitGen&, IntType, double, double)>;
